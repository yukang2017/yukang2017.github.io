...
<div class="yc-nv-card yc-nv-blog-card">
  ...
  <h3><a href="https://research.nvidia.com/labs/eai/blogs/pushing-intelligence-to-4-bit/">Pushing Intelligence to 4-bit</a></h3>
  <p class="yc-nv-blog-meta">How 4-bit quantization becomes practical across training and inference, in LLMs, KV cache, FP4 attention, and video generation.</p>
</div>
...
<div class="yc-nv-card yc-nv-blog-card">
  ...
  <p class="yc-nv-blog-meta">An infra view of KV compression: why attention-score methods collide with FlashAttention and paged attention, and how TriAttention resolves both.</p>
</div>
